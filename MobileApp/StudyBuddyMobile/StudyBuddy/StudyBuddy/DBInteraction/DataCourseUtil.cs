...
namespace StudyBuddy
{
	public class DataCourseUtil
	{
		...
		public static List<Courses> getStudentCourses()
		{
			...
			Courses course1 = new Courses(); 			course1.studentId = 1; 			course1.courseId = 10;

			Courses course2 = new Courses(); 			course2.studentId = 1; 			course2.courseId = 12;

			Courses course3 = new Courses(); 			course3.studentId = 1; 			course3.courseId = 13;

			Courses course4 = new Courses(); 			course4.studentId = 2; 			course4.courseId = 10;

			Courses course5 = new Courses(); 			course5.studentId = 2; 			course5.courseId = 13;

			Courses course6 = new Courses(); 			course6.studentId = 3; 			course6.courseId = 14;

			Courses course7 = new Courses(); 			course7.studentId = 3; 			course7.courseId = 10;

			Courses course8 = new Courses(); 			course8.studentId = 3; 			course8.courseId = 12;
		...
		//Get student by CourseID by StudentID
		public static List<CourseId> getCourseByCourseId()
		{
			...
			for (int i = 0; i < stuCourse.Count; i++)
			{
				...
				if (stuCourse[i].studentId == studentId)
				{
